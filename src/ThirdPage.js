...
// ตัวอย่างการใช้งาน
const colors = ["ขอบคุณน้อง ที่สละเวลามาร่วมแสดงความยินดีในวันปัจฉิมของพี่ การได้รับคำอวยพรและกำลังใจจากน้องๆ ทำให้พี่รู้สึกดีใจและมีความสุขมากๆ ทุกคำพูดและความตั้งใจที่น้องๆ แสดงออกมาในวันนี้มีความหมายอย่างมาก และเป็นสิ่งที่พี่จะเก็บไว้ในความทรงจำเป็นอย่างดี",
